    ...
    public static void inquireUser() throws Exception {
        ...
        while(rs.next()){
            ...
            while (choice.equals("Y")){
                sql="SELECT * FROM microblog WHERE sender_id="+id+" ORDER BY mb_send_time DESC LIMIT "+i+",1";
...
//                    System.out.println("************************************************************************************");
                    System.out.println("************************************************************************************");
                    System.out.println("#"+category+"#"+context+"\t赞："+liked+"\t发送时间："+sendTime);
...
//                    cm[i][j]=new Comment(comment,commentator,commentTime);
                    ...
                    System.out.println("用户目前仅发送了"+i+"条微博");
                    choice="N";
                }
            }
//            System.out.println("************************************************************************************");
...
//            }
    ...
    public static void addFriend(User user) throws Exception {
        ...
        while (checkUserNameExist(friendName)==1) {
